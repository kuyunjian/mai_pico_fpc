...
Q: 这是什么？
A: 这是maipico控制器，在电脑上运行游戏，投屏到maipico显示器上，也就是除了maipico，还需要有一台运行游戏的电脑
...
如果已经起水泡了，不要扣破，一个小孔并且消毒
如果只是起白斑点，不要搓（变白的皮肤非常脆弱），冷却之后伤口才不会留疤
## Ⅲ. 划伤的处理办法
...
1. 如果你想用petg打印键帽，请使用群文件我优化后的模型kouer优化button.stl
2. 并且请向打印的人说明均竖着打印避免层纹，请使用群猫娘给出的**MAI.3mf**文件![[Pasted image 20250211141640.png]]
```
拓大了钢轴孔以适配petg层纹
缩短了按键大小以适配petg层纹（不然会卡键）
```
2. 如果你使用了源按键帽文件打印petg材料，请削以下一条边，以及割以下一条边 #拓展
### <3>.淘宝
3. 电子元器件在淘宝买，而不是拼多多
4. 请前往群内群文件下载**采购清单.txt**
5. 玻璃请前往对应的店家对客服说**一份maip玻璃**，随后他会给出链接拍下即可
6. 各pcb之间的连接线缆实测30awg可用
7. 电烙铁建议买带开关的，并且不要买成外热烙铁头
8. [不要用送的焊锡](https://www.bilibili.com/video/BV1uh411F7KW/ )
9. 亚克力请找深圳裕隆橡胶（精华消息）两套40元包邮 ~~简川旗舰店~~ 亚克力每次请自己上传最近front.dwg , mid.dwg文件（上方ito玻璃可以直接使用他的文件）
10. 外壳——铝型材，383.5两条，图片许久没更新
11. 显示器带挂耳以及没带挂耳的3d转接件，背板固定，参考价格
### <4>.嘉立创
嘉立创优惠券盘点
## Ⅱ. 焊接和测试
### <0>.前言
...
水的形状不像橡皮泥是能捏造的
```
1. 不要用送的焊锡，杂牌英文焊锡，杂质多，熔点高，流动性差，详情请看VCR
2. 良好的焊点是这样的
 - 排针
 - 邮票孔
 - 焊盘
