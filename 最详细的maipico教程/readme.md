...
# 壹：maipico概述
点击红色按钮可以展开大纲，更方便地阅读
![[Pasted image 20250304212549.png]]
...
![[Pasted image 20250304214936.png]]
```
理由：
1. 焊锡丝为了助焊，会有一定比例的松香，吸入过多对肺部有害
2. 焊锡丝会发出的烟含有重金属，吸入过多对人体有害

非常建议自制排风扇，风力很大，但是有一个问题：市面上单独买到的**方转圆法兰导风桶**都不带万向架的安装孔，所以建议直接买成品
...
1.贵，而且强度和树脂一样
2.表面有不明显颗粒感用久了会变脏
3.如果你买的是尼龙粉末烧结成的键帽，大概会堵粉，需要用镊子戳 #拓展，请不要大力出奇迹
...
#### <2.2>.pteg打印说明：
1. 如果你想用petg打印键帽，请使用群文件我优化后的模型kouer优化button.stl，请向打印的人说明均竖着打印避免层纹，请使用群猫娘给出的**MAI.3mf**文件![[Pasted image 20250211141640.png]]
```
优化说明：
拓大了钢轴孔以适配petg层纹
...
```
定制 ITO 镀膜玻璃相对较贵，但我们的尺寸小，所以并不像街机那么贵。这是我订购 ITO 玻璃的店铺，我订购的时候的最小批量是 5 件。据我所知，他们只在中国提供服务。我和他们店铺没有关联，此处提供链接并不表示我为他们的产品和服务负责https://shop378788148.taobao.com/?spm=2013.1.1000126.2.305e16c4LFf1GW
```
4. 各pcb之间的连接线缆实测**最低30awg**够用，**26awg**也可以
5. **电烙铁**建议买带开关的，并且不要买成外热烙铁头
6. [不要用送的焊锡](https://www.bilibili.com/video/BV1uh411F7KW/ )
7. **亚克力**请找深圳裕隆橡胶（精华消息）两套40元包邮 或者**简川旗舰店**（更便宜）` 亚克力每次请自己上传最近下载到的front.dwg , mid.dwg文件避免旧版本文件打印出来应发争议`（上方ito玻璃可以直接使用他的文件，不用自己上传文件~~而且ito玻璃属于批量定制，上传了也没用~~）
8. **外壳の铝型材**：github上imfrea的图片没更新，以383.5mm两根252mm一根为准，去嘉立创领取20元fa商城新人券然后凑点螺丝可以仅邮费下单
...
![[Pasted image 20250303135920.png]]
