...
- 你能找到另一个分支[imfrea](https://github.com/imfrea/mai_pico)的，这是一位群友，在他的readme_cn教程更为详细

快速入门：
成本：全部最低配750（包括试错和工具，不包括打碎玻璃）
pcb：两部分，你需要打样八个button和一个io（后续的分体版本有三部分）

值得一提的是：在做完一个maipico前，其它部分视频看看就好，不用看懂一样能做出maipico
