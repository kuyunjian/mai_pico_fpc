...
## Ⅱ. 焊接和测试
### <0>. 前言
如图你需要焊接一块io和一串buttonpcb，这是这个项目需要的所有9块pcb（不算树莓派和io通过线连的pn532的话）
...
```
下图仍然有一个不当的地方，斑马纸和玻璃交界处的边缘不应该用电烙铁压接，（留出1mm左右的安全距离），以便后续有方法使得斑马纸连接更稳固：
...
1. **显示器**
	...
	- </br>  <img src="photo/00doc/Pasted image 20250310184541.png" width="60%">  </br></br>  <img src="13421d7ae6053a68926b8e41b8b38d4c.jpg" width="60%">  </br>
...
就是这些东西展开来估计可以讲两个这个文档（这个文档截止目前已经25523字了，等把tdl做完估计会到5w字左右）
